...
class RedisTests {
    ...
    @Autowired
    CacheManager cacheManager;  //注入CacheManager
    ...
    public void test02() {
        ...
        emp.setId(10);
        emp.setLastName("abc");
        emp.setDId((int)(System.currentTimeMillis()));
        redisTemplate.opsForValue().set("emp-10",emp);
        System.out.println("end...");
    }
    ...
    public void test03() {
        ...
        Cache redisCache = cacheManager.getCache("emp");
        System.out.println(redisCache);
        Cache.ValueWrapper valueWrapper = redisCache.get("1");
